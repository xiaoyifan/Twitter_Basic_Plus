...
$query = "SELECT A.TweetID, A.TweetContents, A.time, A.address
FROM Tweet A
JOIN Favorite B ON B.TweetID = A.TweetID
JOIN User C ON C.UserID = B.UserID
WHERE C.Email = '$user'";
