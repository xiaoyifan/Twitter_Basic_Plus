...
$query = "SELECT TweetID, TweetContents, address, time
          FROM Tweet
          ORDER BY time DESC";
...
$result = mysqli_query($dbcon, $query)
 ...
 $user_label = "tweets list";

 $table_content = "<tr><td><a href=\"list_tweetInfo.php?TweetID=$tuple[0]\">$tuple[0]</a></td><td>$tuple[1]</td><td>$tuple[2]</td><td>$tuple[3]</td></tr>";
              ...
              <div class = "detail">  
                <table class = "table table-striped" >
                  <tr>
                    ...
                    <th style="text-align:center">Tweet Contents</th>
