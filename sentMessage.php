...
$client = $_SESSION['clientUser'];

 $user_label = "New Message Info";
...
$query = "INSERT INTO Message(MessageID, MessageContents, time)
          VALUES('$tu[0]', '$message', '$timeNow')";
...
$result = mysqli_query($dbcon, $query)
 ...
 $content = "<ul>
                  <li>Message ID: $tu[0]</li>
                  <li>Meesage Contents: $message</li>
                  <li>time: $timeNow</li>
            </ul>";
...
$queryPost = "INSERT INTO Sending(SenderID, MessageID, ReceiverID)
          VALUES('$tupleUser[0]', '$tu[0]','$client')";
$resultPost = mysqli_query($dbcon, $queryPost)
  or die('Query failed: ' . mysqli_error($dbcon));
