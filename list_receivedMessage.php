...
$User_mail = $_SESSION["currentUser"];

// Get the attributes of the user with the given username
$query = "SELECT A.MessageID, A.MessageContents, A.time, C.UserName
FROM Message A
join Sending B ON B.MessageID = A.MessageID
join User C ON B.SenderID = C.UserID
join User D ON B.ReceiverID = D.UserID
WHERE D.Email = '$User_mail'";

$result = mysqli_query($dbcon, $query)
  or die('Query failed: ' . mysqli_error($dbcon));


 $user_label = "Message received";
              ...
              <div class = "detail">  
                <table class = "table table-striped" >
                  <tr>
                    ...
                    <th style="text-align:center">Message Contents</th>
